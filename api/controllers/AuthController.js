    ...
    try{
        ...
        if(userData.length > 0)
        {
            ...
            res.status(200).send( {
                ...
                message: "This username and email is already exists, please enter another one !"
            })
          ...
          cloudinary.config({
            ...
            console.log(addFile);
            const result = await cloudinary.uploader.upload(addFile[0].fd, {folder: 'SMP', public_id: addFile[0].filename})       
